...
license: MIT
allowed-tools: mcp__remote__get_current_user, mcp__remote__list_employee_timeoffs, mcp__remote__get_timeoff_leave_policies_summary, mcp__remote__get_work_calendar, mcp__remote__create_employee_timeoff_request, mcp__remote__cancel_employee_timeoff_request, mcp__remote__request_cancel_employee_timeoff, mcp__remote__list_team_members, mcp__remote__list_company_employments, mcp__remote__list_timeoffs, mcp__remote__get_timeoff_stats, mcp__remote__approve_timeoff, mcp__remote__decline_timeoff, mcp__remote__get_timeoff_dashboard, mcp__remote__get_timeoff_team_absence_timeline, mcp__remote__list_employee_timeoff_leave_policies_summary, mcp__remote__create_timeoff, mcp__remote__list_timeoff_leave_policies, mcp__remote__list_company_public_holidays, mcp__remote__create_company_public_holiday, mcp__remote__approve_draft_holidays
---
...
| "Who's out the week of X?" | `list_timeoffs` with date range filter | Use `statuses: ["approved"]` for *planned/upcoming/scheduled* — pending and requested do not count. |
